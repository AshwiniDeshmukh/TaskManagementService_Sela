...
{
    internal class GetTasksDelegate : QueryCallDelegate<IEnumerable<PatientSummaryEntity>>
    {
        private readonly IEnumerable<Guid> _patientKeys;

        public GetTasksDelegate(QueryScripts queryScripts, IEnumerable<Guid> patientKeys)
